...
Source page: https://www.redsrrc.com/
...
Build the `/` route as a polished, responsive page that matches the intended layout and is fully wired.

## Work from the spec

- **Spec:** `rebuild/page-specs/home.md` — section-by-section layout, visual cues, CTAs, components, and responsive notes.
- **Screenshots:** `pages/cc4a84e52c0f0d87/desktop-full.png`, `pages/cc4a84e52c0f0d87/mobile-full.png` (view if you can; else use the spec).
- **Copy:** `rebuild/03-page-copy-plan.json` + `pages/cc4a84e52c0f0d87/analysis/text.json`.
