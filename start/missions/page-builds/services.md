...
Source page: https://www.redsrrc.com/services
...
Build the `/services` route as a polished, responsive page that matches the intended layout and is fully wired.

## Work from the spec

- **Spec:** `rebuild/page-specs/services.md` — section-by-section layout, visual cues, CTAs, components, and responsive notes.
- **Screenshots:** `pages/47769ccb9f9b1156/desktop-full.png`, `pages/47769ccb9f9b1156/mobile-full.png` (view if you can; else use the spec).
- **Copy:** `rebuild/03-page-copy-plan.json` + `pages/47769ccb9f9b1156/analysis/text.json`.
