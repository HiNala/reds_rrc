# Page Build — `/service-page/client-callback`

Project: redsrrc-com-bundle
Source page: https://www.redsrrc.com/service-page/client-callback
...
Build the `/service-page/client-callback` route as a polished, responsive page that matches the intended layout and is fully wired.

## Work from the spec

- **Spec:** `rebuild/page-specs/service-page-client-callback.md` — section-by-section layout, visual cues, CTAs, components, and responsive notes.
- **Screenshots:** `pages/a50d937238dfdfff/desktop-full.png`, `pages/a50d937238dfdfff/mobile-full.png` (view if you can; else use the spec).
- **Copy:** `rebuild/03-page-copy-plan.json` + `pages/a50d937238dfdfff/analysis/text.json`.
- **Metadata:** `rebuild/06-metadata-map.json` for this route.

## Build

1. Create `src/app/service-page/client-callback/page.tsx`.
