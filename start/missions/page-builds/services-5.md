# Page Build — `/services-5`

Project: redsrrc-com-bundle
Source page: https://www.redsrrc.com/services-5
...
Build the `/services-5` route as a polished, responsive page that matches the intended layout and is fully wired.

## Work from the spec

- **Spec:** `rebuild/page-specs/services-5.md` — section-by-section layout, visual cues, CTAs, components, and responsive notes.
- **Screenshots:** `pages/b2f46b066843f600/desktop-full.png`, `pages/b2f46b066843f600/mobile-full.png` (view if you can; else use the spec).
- **Copy:** `rebuild/03-page-copy-plan.json` + `pages/b2f46b066843f600/analysis/text.json`.
- **Metadata:** `rebuild/06-metadata-map.json` for this route.

## Build

1. Create `src/app/services-5/page.tsx`.
