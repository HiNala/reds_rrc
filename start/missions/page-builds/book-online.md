# Page Build — `/book-online`

Project: redsrrc-com-bundle
Source page: https://redsrrc.com/book-online
...
Build the `/book-online` route as a polished, responsive page that matches the intended layout and is fully wired.

## Work from the spec

- **Spec:** `rebuild/page-specs/book-online.md` — section-by-section layout, visual cues, CTAs, components, and responsive notes.
- **Screenshots:** `pages/d55ee22b4a6a506c/desktop-full.png`, `pages/d55ee22b4a6a506c/mobile-full.png` (view if you can; else use the spec).
- **Copy:** `rebuild/03-page-copy-plan.json` + `pages/d55ee22b4a6a506c/analysis/text.json`.
- **Metadata:** `rebuild/06-metadata-map.json` for this route.

## Build

1. Create `src/app/book-online/page.tsx`.
