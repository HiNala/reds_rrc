# Contraction Prompt — After Mission 03: Content & Copy

## Project: redsrrc-com-bundle

## Instructions

After completing Mission 03 (Content & Copy), answer these questions:
...
- 282 text blocks extracted
- 957 total words
- Verify copy against `rebuild/03-page-copy-plan.json`
...
Write your contraction report to `rebuild/contraction-reports/after-mission-03.md`.
