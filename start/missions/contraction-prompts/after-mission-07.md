# Contraction Prompt — After Mission 07: Components & Layouts

## Project: redsrrc-com-bundle

## Instructions

After completing Mission 07 (Components & Layouts), answer these questions:
...
- Types: FooterColumn, Form, Header, Main, Navbar, Section
- Verify against `rebuild/07-component-map.json`
...
Write your contraction report to `rebuild/contraction-reports/after-mission-07.md`.
