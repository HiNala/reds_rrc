# Contraction Prompt — After Mission 02: Information Architecture

## Project: redsrrc-com-bundle

## Instructions

After completing Mission 02 (Information Architecture), answer these questions:
...
- 8 pages to map
- Check `rebuild/02-url-map.json` for route mappings
- Check `rebuild/02-new-sitemap.md` for proposed sitemap
...
Write your contraction report to `rebuild/contraction-reports/after-mission-02.md`.
