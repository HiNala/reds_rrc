...
- **Lane (owns):** `content/ (MDX/copy)` — only create/edit files here to stay collision-free.
- **Depends on:** Mission 01
- **Parallel-safe with:** Mission 02, Mission 04, Mission 05, Mission 06
- **Suggested wave:** 1
...
Plan and write page copy. Use `rebuild/03-page-copy-plan.json` and `pages/*/analysis/text.json`.
Respect `content_strategy` flags on each CopyBlock. Output: copy plan per page.

## Extracted Data Summary

- Total copy blocks: 282
