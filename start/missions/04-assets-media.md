...
- **Lane (owns):** `public/ assets + media` — only create/edit files here to stay collision-free.
- **Depends on:** Mission 01
- **Parallel-safe with:** Mission 02, Mission 03, Mission 05, Mission 06
- **Suggested wave:** 1
...
Organize and optimize assets. Use `assets/asset-manifest.json` and `pages/*/analysis/images.json`.
Determine which assets to keep, replace, or create. Output: asset plan.

## Extracted Data Summary

- Image candidates: 253
- Asset types downloaded: images, CSS, fonts, JS, video, favicon, manifest
## Bundle References
